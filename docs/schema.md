...
| `attempts` | worker/reaper | nombre de claims — et token de fencing : chaque écriture du worker exige `attempts = <sa tentative>` ; au-delà d'un seuil le reaper passe en `failed` |
